...
src/capture/%.o: ../src/capture/%.cpp
	...
	/usr/local/cuda-9.0/bin/nvcc -Dlinux -I/usr/include/opencv -I/usr/include/GL -I../include -I../include/osa -I../src -I../src/capture -I../src/comm -G -g -O0 -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_50,code=sm_50 -m64 -odir "src/capture" -M -o "$(@:%.o=%.d)" "$<"
