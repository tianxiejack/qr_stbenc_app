...
src/comm/%.o: ../src/comm/%.cpp
	...
	/usr/local/cuda-9.0/bin/nvcc -Dlinux -I/usr/include/opencv -I/usr/include/GL -I../include -I../include/osa -I../src -I../src/capture -I../src/comm -O3 -std=c++11 -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_50,code=sm_50 -m64 -odir "src/comm" -M -o "$(@:%.o=%.d)" "$<"
